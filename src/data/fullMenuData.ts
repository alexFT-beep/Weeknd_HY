/**
 * @file fullMenuData.ts
 * @description Repositorio central de datos y tipos inmutables del menú gastronómico,
 * promociones, categorías neón, zonas de delivery y datos de contacto de Weekend Huarmey.
 */

/** Representa una categoría del menú gastronómico con su respectivo tema de color neón */
...
/** Configuración de zona geográfica para la tarifa de delivery */
...
/** Opción de empaque o táper adicional para envíos a domicilio */
...
/** Ítem individual del catálogo de productos de la carta digital */
export interface MenuItem {
  ...
  readonly tapersCount?: number;
}

/** Información de pago y contacto corporativo */
...
export const MENU_CATEGORIES: Category[] = [
  ...
  { id: "a-la-carta", name: "Weekend a la Carta", emoji: "🍛", color: "#FF007F", rgb: "255, 0, 127", description: "Chaufas, aeropuertos, saltados y platos tradicionales a la carta" },
...
export const FULL_MENU_ITEMS: MenuItem[] = [
  ...
  { id: "nug-04", name: "Nuggets Four (10 Und)", price: 30, category: "piqueos", subcategory: "piqueos", description: "10 unidades + papas fritas + salsa 04 quesos", tapersCount: 1 },

  // =================== WEEKEND A LA CARTA ===================
  { id: "alc-01", name: "Arroz a la Cubana", price: 18, category: "a-la-carta", subcategory: "a-la-carta", description: "Arroz blanco, plátano frito, huevo frito y papas fritas", tapersCount: 1 },
  { id: "alc-02", name: "Chaufa d' Pollo", price: 25, category: "a-la-carta", subcategory: "a-la-carta", description: "Arroz chaufa al wok con trozos de pollo tierno y huevo", tapersCount: 1 },
  { id: "alc-03", name: "Chaufa d' Chancho", price: 25, category: "a-la-carta", subcategory: "a-la-carta", description: "Arroz chaufa al wok con trozos de cerdo crujiente", tapersCount: 1 },
  { id: "alc-04", name: "Chaufa d' Carne (Lomo Fino)", price: 33, category: "a-la-carta", subcategory: "a-la-carta", description: "Arroz chaufa al wok con finos cortes de lomo fino", tapersCount: 1 },
  { id: "alc-05", name: "Chaufa d' Langostinos", price: 33, category: "a-la-carta", subcategory: "a-la-carta", description: "Arroz chaufa al wok con langostinos frescos salteados", tapersCount: 1 },
  { id: "alc-06", name: "Aeropuerto d' Pollo", price: 27, category: "a-la-carta", subcategory: "a-la-carta", description: "Fusión de chaufa de pollo y fideos salteados al wok con frejol chino", tapersCount: 1 },
  { id: "alc-07", name: "Aeropuerto d' Chancho", price: 27, category: "a-la-carta", subcategory: "a-la-carta", description: "Fusión de chaufa de cerdo y fideos salteados al wok con frejol chino", tapersCount: 1 },
  { id: "alc-08", name: "Aeropuerto d' Carne (Lomo Fino)", price: 34, category: "a-la-carta", subcategory: "a-la-carta", description: "Fusión de chaufa de lomo fino y fideos salteados al wok con frejol chino", tapersCount: 1 },
  { id: "alc-09", name: "Aeropuerto d' Langostinos", price: 34, category: "a-la-carta", subcategory: "a-la-carta", description: "Fusión de chaufa de langostinos y fideos salteados al wok con frejol chino", tapersCount: 1 },
  { id: "alc-10", name: "Chaufa Especial Weekend", price: 40, category: "a-la-carta", subcategory: "a-la-carta", description: "Combinación suprema al wok: Pollo, chancho, carne (lomo fino) y langostinos", badge: "ESPECIAL", tapersCount: 1 },
  { id: "alc-11", name: "Aeropuerto Especial Weekend", price: 40, category: "a-la-carta", subcategory: "a-la-carta", description: "Combinación suprema al wok: Pollo, chancho, carne (lomo fino) y langostinos", badge: "ESPECIAL", tapersCount: 1 },
  { id: "alc-12", name: "Pollo Saltado", price: 28, category: "a-la-carta", subcategory: "a-la-carta", description: "Jugosos trozos de pollo salteados al wok con cebolla, tomate, papas fritas y arroz blanco", tapersCount: 1 },
  { id: "alc-13", name: "Lomo Fino Saltado", price: 40, category: "a-la-carta", subcategory: "a-la-carta", description: "Fino lomo flameado al wok con cebolla, tomate, papas fritas y arroz blanco", badge: "FAVORITO", tapersCount: 1 },
  { id: "alc-14", name: "Milanesa", price: 28, category: "a-la-carta", subcategory: "a-la-carta", description: "Pechuga empanizada crocante acompañada de arroz blanco, papas fritas y ensalada", tapersCount: 1 },
  { id: "alc-15", name: "Pollo a la Plancha", price: 28, category: "a-la-carta", subcategory: "a-la-carta", description: "Filete de pechuga a la plancha con arroz blanco, papas fritas y ensalada fresca", tapersCount: 1 },
  { id: "alc-16", name: "Pollo Frito", price: 28, category: "a-la-carta", subcategory: "a-la-carta", description: "Piezas de pollo dorado y crocante con arroz blanco, papas fritas y ensalada", tapersCount: 1 },
  { id: "alc-17", name: "Chuleta Ahumada", price: 28, category: "a-la-carta", subcategory: "a-la-carta", description: "Jugosa chuleta de cerdo ahumada servida con arroz blanco, papas fritas y ensalada", tapersCount: 1 },
  { id: "alc-18", name: "Bisteck (Lomo Fino)", price: 40, category: "a-la-carta", subcategory: "a-la-carta", description: "Bisteck de lomo fino tierno acompañado de arroz blanco, papas fritas y ensalada", tapersCount: 1 },
  { id: "alc-19", name: "Alitas + Chaufa", price: 35, category: "a-la-carta", subcategory: "a-la-carta", description: "05 unidades de alitas + papas fritas + porción de chaufa + 01 salsa a elegir", badge: "COMBO TOP", tapersCount: 1 },
  ...
  // =================== 10. JUGOS, SMOOTHIES & FRAPPES ===================
  { id: "sm-01", name: "Smoothies D' Fresa", price: 15, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-02", name: "Smoothies D' Maracuyá", price: 15, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-03", name: "Smoothies D' Plátano", price: 15, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-04", name: "Smoothies D' Arándanos", price: 16, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-05", name: "Smoothies D' Mango", price: 16, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-06", name: "Smoothies D' Matcha", price: 16, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-07", name: "Smoothies D' Maracumango", price: 17, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-08", name: "Smoothies D' Piña Colada", price: 18, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },
  { id: "sm-09", name: "Smoothies Tropical", price: 18, category: "jugos", subcategory: "smoothies", description: "100% Natural", tapersCount: 1 },

  // =================== 11. BUBBLE TEA & MILKSHAKES ===================
  ...
  // =================== 12. JUGOS Y FRAPPES ===================
  { id: "jug-01", name: "Jugo de Papaya", price: 12, category: "jugos", subcategory: "jugos-frappes", description: "Jugo 100% natural", tapersCount: 1 },
  { id: "jug-02", name: "Jugo de Piña", price: 13, category: "jugos", subcategory: "jugos-frappes", description: "Jugo 100% natural", tapersCount: 1 },
  { id: "jug-03", name: "Jugo de Fresa", price: 13, category: "jugos", subcategory: "jugos-frappes", description: "Jugo 100% natural", tapersCount: 1 },
  { id: "jug-04", name: "Jugo de Mango", price: 13, category: "jugos", subcategory: "jugos-frappes", description: "Jugo 100% natural", tapersCount: 1 },
  { id: "jug-05", name: "Jugo de Melón", price: 13, category: "jugos", subcategory: "jugos-frappes", description: "Jugo 100% natural", tapersCount: 1 },
  { id: "jug-06", name: "Jugo Surtido", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Mix de frutas naturales", tapersCount: 1 },
  { id: "jug-07", name: "Jugo Fresa c/ Piña", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Fresa y piña natural", tapersCount: 1 },
  { id: "jug-08", name: "Jugo Papaya c/ Piña", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Papaya y piña natural", tapersCount: 1 },
  { id: "jug-09", name: "Jugo Papaya c/ Melón", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Papaya y melón natural", tapersCount: 1 },
  { id: "jug-10", name: "Jugo Mango c/ Piña", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Mango y piña natural", tapersCount: 1 },
  { id: "jug-11", name: "Jugo Mango c/ Fresa", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Mango y fresa natural", tapersCount: 1 },
  { id: "jug-12", name: "Jugo Plátano c/ Leche", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Plátano batido con leche", tapersCount: 1 },
  { id: "jug-13", name: "Jugo Papaya c/ Leche", price: 15, category: "jugos", subcategory: "jugos-frappes", description: "Papaya batida con leche", tapersCount: 1 },
  { id: "jug-14", name: "Jugo de Arándanos", price: 16, category: "jugos", subcategory: "jugos-frappes", description: "Arándanos naturales", tapersCount: 1 },
  { id: "jug-15", name: "Jugo Mango c/ Leche", price: 17, category: "jugos", subcategory: "jugos-frappes", description: "Mango batido con leche", tapersCount: 1 },
  { id: "jug-16", name: "Jugo Fresa c/ Leche", price: 17, category: "jugos", subcategory: "jugos-frappes", description: "Fresa batida con leche", tapersCount: 1 },
  { id: "jug-17", name: "Jugo Especial", price: 20, category: "jugos", subcategory: "jugos-frappes", description: "Frutas mixtas, huevo, leche y algarrobina", tapersCount: 1 },
  { id: "jug-18", name: "Jugo Arándanos c/ Leche", price: 22, category: "jugos", subcategory: "jugos-frappes", description: "Arándanos batidos con leche", tapersCount: 1 },
  { id: "frap-01", name: "Frappe D' Fresa", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-02", name: "Frappe D' Chocolate", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-03", name: "Frappe D' Algarrobina", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-04", name: "Frappe D' Moca", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-05", name: "Frappe D' Oreo", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe con galletas Oreo", tapersCount: 1 },
  { id: "frap-06", name: "Frappe D' Vainilla", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-07", name: "Frappe D' Durazno", price: 15.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-08", name: "Frappe D' Arándanos", price: 16.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-09", name: "Frappe D' Mango", price: 16.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-10", name: "Frappe D' Maracumango", price: 16.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe 100% natural", tapersCount: 1 },
  { id: "frap-11", name: "Frappe D' Matcha", price: 16.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe de té matcha", tapersCount: 1 },
  { id: "frap-12", name: "Frappe D' Piña Colada", price: 19.50, category: "jugos", subcategory: "jugos-frappes", description: "Frappe estilo piña colada", tapersCount: 1 },

  // =================== 13. REFRESCOS & BEBIDAS ===================
  ...
  { id: "jarra-14", name: "Jarra Tropical S/H (1L)", price: 17, category: "refrescos", subcategory: "refrescos", description: "Jarra de 1 Litro sin helar" },
