...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-weekend-neon selection:text-black">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="absolute bottom-8 landscape:hidden left-0 w-full text-center z-10">
              <p className="text-white font-black text-xl uppercase tracking-[0.3em]">WEEKND!</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <section id="menu" className="relative py-24 overflow-hidden min-h-[80vh] flex items-center bg-[#08080a] border-t border-white/5">
      ...
      <section id="reserva" className="relative py-24 bg-[#050508] border-t border-white/5">
      ...
      <section id="delivery" className="relative py-32 overflow-hidden bg-[#050508] border-t border-white/5">
      ...
      <footer id="contacto" className="relative pt-24 pb-12 overflow-hidden border-t border-white/10">
        <div className="absolute inset-0 z-0">
          <img
            src={FOOTER_IMG}
            ...
            <div className="col-span-1 lg:col-span-1">
              <div className="flex items-center gap-3 mb-6">
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                <span className="text-white font-black tracking-tighter text-xl uppercase">WEEKEND!</span>
              </div>
